...
set genomeRtd $env(RT_TMP)/52E61E20.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {GBCR2_SEU_Test__GCB0}]"
...
set genomeName [subst -nocommands -novariables {GBCR2_SEU_Test__GCB0}]
