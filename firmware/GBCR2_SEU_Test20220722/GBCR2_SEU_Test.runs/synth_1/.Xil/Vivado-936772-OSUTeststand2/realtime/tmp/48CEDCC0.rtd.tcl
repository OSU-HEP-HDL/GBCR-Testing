...
set genomeRtd $env(RT_TMP)/48CEDCC0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {GBCR2_SEU_Test__GCB1}]"
...
set genomeName [subst -nocommands -novariables {GBCR2_SEU_Test__GCB1}]
