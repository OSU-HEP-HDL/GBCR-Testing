...
set genomeRtd $env(RT_TMP)/2FE81B00.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Data_Checker__GB2}]"
...
set genomeName [subst -nocommands -novariables {Data_Checker__GB2}]
