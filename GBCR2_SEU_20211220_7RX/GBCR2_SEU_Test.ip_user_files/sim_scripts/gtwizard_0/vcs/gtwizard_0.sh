...
#
# Script generated by Vivado on Wed Jun 26 18:33:50 CDT 2024
...
#
# Usage        : gtwizard_0.sh
#                gtwizard_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gtwizard_0.sh [-reset_run]
#                gtwizard_0.sh [-reset_log]
#                gtwizard_0.sh [-help]
#
...
#                script (type 'gtwizard_0.sh -help' for more information).
#
...
# script info
echo -e "gtwizard_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gtwizard_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(ucli.key gtwizard_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gtwizard_0_simv.daidir vcs_lib c.obj)
...
Usage: gtwizard_0.sh [-step]\n\
Usage: gtwizard_0.sh [-lib_map_path]\n\
Usage: gtwizard_0.sh [-reset_run]\n\
Usage: gtwizard_0.sh [-reset_log]\n\
Usage: gtwizard_0.sh [-keep_index]\n\
