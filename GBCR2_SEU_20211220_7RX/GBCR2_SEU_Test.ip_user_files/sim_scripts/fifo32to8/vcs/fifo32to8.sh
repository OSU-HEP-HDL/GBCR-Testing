...
#
# Script generated by Vivado on Wed Jun 26 18:33:38 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo32to8.sh
...
#
# Usage        : fifo32to8.sh
#                fifo32to8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo32to8.sh [-reset_run]
#                fifo32to8.sh [-reset_log]
#                fifo32to8.sh [-help]
#
...
#                script (type 'fifo32to8.sh -help' for more information).
#
...
# script info
echo -e "fifo32to8.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo32to8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo32to8 xil_defaultlib.glbl -o fifo32to8_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo32to8_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo32to8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo32to8_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo32to8.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo32to8.sh [-help]\n\
Usage: fifo32to8.sh [-step]\n\
Usage: fifo32to8.sh [-lib_map_path]\n\
Usage: fifo32to8.sh [-reset_run]\n\
Usage: fifo32to8.sh [-reset_log]\n\
Usage: fifo32to8.sh [-keep_index]\n\
Usage: fifo32to8.sh [-noclean_files]\n\n\
