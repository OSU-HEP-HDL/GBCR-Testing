...
#
# Script generated by Vivado on Wed Jun 26 18:33:40 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo36x512.sh
...
#
# Usage        : fifo36x512.sh
#                fifo36x512.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo36x512.sh [-reset_run]
#                fifo36x512.sh [-reset_log]
#                fifo36x512.sh [-help]
#
...
#                script (type 'fifo36x512.sh -help' for more information).
#
...
# script info
echo -e "fifo36x512.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo36x512.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo36x512 xil_defaultlib.glbl -o fifo36x512_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo36x512_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo36x512_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo36x512_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo36x512.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo36x512.sh [-help]\n\
Usage: fifo36x512.sh [-step]\n\
Usage: fifo36x512.sh [-lib_map_path]\n\
Usage: fifo36x512.sh [-reset_run]\n\
Usage: fifo36x512.sh [-reset_log]\n\
Usage: fifo36x512.sh [-keep_index]\n\
Usage: fifo36x512.sh [-noclean_files]\n\n\
