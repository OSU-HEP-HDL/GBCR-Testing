...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo36x512 xil_defaultlib.fifo36x512 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo36x512 -key {Behavioral:sim_1:Functional:fifo36x512} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo36x512.wdb xsim.dir libdpi.so)
