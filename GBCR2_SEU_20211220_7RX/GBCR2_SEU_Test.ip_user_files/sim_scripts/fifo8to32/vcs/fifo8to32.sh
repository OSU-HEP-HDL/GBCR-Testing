...
#
# Script generated by Vivado on Wed Jun 26 18:33:42 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo8to32.sh
...
#
# Usage        : fifo8to32.sh
#                fifo8to32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo8to32.sh [-reset_run]
#                fifo8to32.sh [-reset_log]
#                fifo8to32.sh [-help]
#
...
#                script (type 'fifo8to32.sh -help' for more information).
#
...
# script info
echo -e "fifo8to32.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo8to32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo8to32 xil_defaultlib.glbl -o fifo8to32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo8to32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo8to32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo8to32_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo8to32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo8to32.sh [-help]\n\
Usage: fifo8to32.sh [-step]\n\
Usage: fifo8to32.sh [-lib_map_path]\n\
Usage: fifo8to32.sh [-reset_run]\n\
Usage: fifo8to32.sh [-reset_log]\n\
Usage: fifo8to32.sh [-keep_index]\n\
Usage: fifo8to32.sh [-noclean_files]\n\n\
