...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L axi_lite_ipif_v3_0_4 -L tri_mode_ethernet_mac_v9_0_32 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tri_mode_ethernet_mac_0 xil_defaultlib.tri_mode_ethernet_mac_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tri_mode_ethernet_mac_0.wdb xsim.dir libdpi.so)
