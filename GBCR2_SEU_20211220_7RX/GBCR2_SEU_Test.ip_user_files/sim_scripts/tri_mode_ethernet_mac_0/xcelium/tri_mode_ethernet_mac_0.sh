...
#
# Script generated by Vivado on Wed Jun 26 18:33:53 CDT 2024
...
#
# Usage        : tri_mode_ethernet_mac_0.sh
#                tri_mode_ethernet_mac_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tri_mode_ethernet_mac_0.sh [-reset_run]
#                tri_mode_ethernet_mac_0.sh [-reset_log]
#                tri_mode_ethernet_mac_0.sh [-help]
#
...
#                script (type 'tri_mode_ethernet_mac_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_13 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname axi_lite_ipif_v3_0_4 -libname tri_mode_ethernet_mac_v9_0_32 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 axi_lite_ipif_v3_0_4 tri_mode_ethernet_mac_v9_0_32 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "tri_mode_ethernet_mac_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tri_mode_ethernet_mac_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work tri_mode_ethernet_mac_v9_0_32 $xmvlog_opts \
  "../../../ipstatic/hdl/tri_mode_ethernet_mac_v9_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvhdl -work tri_mode_ethernet_mac_v9_0_32 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tri_mode_ethernet_mac_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tri_mode_ethernet_mac_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hep/Desktop/GBCR_Work/firmware/GBCR2_SEU_Test20220722/GBCR2_SEU_Test.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tri_mode_ethernet_mac_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: tri_mode_ethernet_mac_0.sh [-step]\n\
Usage: tri_mode_ethernet_mac_0.sh [-lib_map_path]\n\
Usage: tri_mode_ethernet_mac_0.sh [-reset_run]\n\
Usage: tri_mode_ethernet_mac_0.sh [-reset_log]\n\
Usage: tri_mode_ethernet_mac_0.sh [-keep_index]\n\
