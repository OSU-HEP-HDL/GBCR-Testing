...
design_libs=(xpm xbip_utils_v3_0_13 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 axi_lite_ipif_v3_0_4 tri_mode_ethernet_mac_v9_0_32 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work tri_mode_ethernet_mac_v9_0_32 $vlogan_opts +v2k \
  "../../../ipstatic/hdl/tri_mode_ethernet_mac_v9_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vhdlan -work tri_mode_ethernet_mac_v9_0_32 $vhdlan_opts \
...
reset_run()
{
  files_to_remove=(ucli.key tri_mode_ethernet_mac_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tri_mode_ethernet_mac_0_simv.daidir vcs_lib c.obj)
