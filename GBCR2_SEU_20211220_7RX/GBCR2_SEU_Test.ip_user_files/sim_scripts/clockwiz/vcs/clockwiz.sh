...
#
# Script generated by Vivado on Thu Jun 27 23:26:34 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clockwiz.sh
...
#
# Usage        : clockwiz.sh
#                clockwiz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clockwiz.sh [-reset_run]
#                clockwiz.sh [-reset_log]
#                clockwiz.sh [-help]
#
...
#                script (type 'clockwiz.sh -help' for more information).
#
...
# script info
echo -e "clockwiz.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clockwiz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../firmware/GBCR2_SEU_Test20220722/GBCR2_SEU_Test.gen/sources_1/ip/clockwiz" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../firmware/GBCR2_SEU_Test20220722/GBCR2_SEU_Test.gen/sources_1/ip/clockwiz" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clockwiz xil_defaultlib.glbl -o clockwiz_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clockwiz_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clockwiz_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clockwiz_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clockwiz.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clockwiz.sh [-help]\n\
Usage: clockwiz.sh [-step]\n\
Usage: clockwiz.sh [-lib_map_path]\n\
Usage: clockwiz.sh [-reset_run]\n\
Usage: clockwiz.sh [-reset_log]\n\
Usage: clockwiz.sh [-keep_index]\n\
Usage: clockwiz.sh [-noclean_files]\n\n\
