...
#
# Script generated by Vivado on Wed Jun 26 18:33:45 CDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_128to128_depth1k.sh
...
#
# Usage        : fifo_128to128_depth1k.sh
#                fifo_128to128_depth1k.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_128to128_depth1k.sh [-reset_run]
#                fifo_128to128_depth1k.sh [-reset_log]
#                fifo_128to128_depth1k.sh [-help]
#
...
#                script (type 'fifo_128to128_depth1k.sh -help' for more information).
#
...
# script info
echo -e "fifo_128to128_depth1k.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_128to128_depth1k.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_128to128_depth1k xil_defaultlib.glbl -o fifo_128to128_depth1k_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_128to128_depth1k_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hep/Desktop/GBCR_Work/firmware/GBCR2_SEU_Test20220722/GBCR2_SEU_Test.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fifo_128to128_depth1k_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_128to128_depth1k_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_128to128_depth1k.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_128to128_depth1k.sh [-help]\n\
Usage: fifo_128to128_depth1k.sh [-step]\n\
Usage: fifo_128to128_depth1k.sh [-lib_map_path]\n\
Usage: fifo_128to128_depth1k.sh [-reset_run]\n\
Usage: fifo_128to128_depth1k.sh [-reset_log]\n\
Usage: fifo_128to128_depth1k.sh [-keep_index]\n\
Usage: fifo_128to128_depth1k.sh [-noclean_files]\n\n\
